    ...
    return (
        <>
            ...
            <div className="cartInfo-buy">
                <button className="cartInfo-buy-btn" onClick={createNewOrder} disabled={isSubmitting}>
                    {isSubmitting ?
                    <>
                    <span>Cargando </span><span className="loadingScreen-spinner spinnerInCart"></span>
                    </>
                    : 'Comprar Carrito'}
                    {!isSubmitting && <svg xmlns="http://www.w3.org/2000/svg" className="cartWidgetContainer-link-svg bi bi-cart2" viewBox="0 0 16 16">
